...
BK_DEPS = /home/leonti/usa/etmmanager/bk-deps
srcdir = .
...
DESTDIR = 
ETMMANAGER_CXXFLAGS = -I/usr/include/mysql -I/usr/local/include/mysql++ \
	-I/usr/include/mysql++ -Wall $(CPPFLAGS) $(CXXFLAGS)
ETMMANAGER_OBJECTS =  \
...
install: install_etmmanager
	...
	(cd $(srcdir)/src ; $(INSTALL_DATA)  etmmanager.desktop $(DESTDIR)$(datadir)/applications)
...
uninstall: uninstall_etmmanager
	...
	(cd $(DESTDIR)$(datadir)/applications ; rm -f etmmanager.desktop)
	(cd $(DESTDIR)$(datadir)/pixmaps ; rm -f etmmanager.png)
...
etmmanager$(EXEEXT): $(ETMMANAGER_OBJECTS) $(__etmmanager___win32rc)
	$(CXX) -o $@ $(ETMMANAGER_OBJECTS)   $(LDFLAGS_GUI) $(LDFLAGS)  -lmysqlpp -lmysqlclient $(LIBS)
	
	$(__etmmanager___mac_setfilecmd)
	$(__etmmanager___os2_emxbindcmd)

install_etmmanager: etmmanager$(EXEEXT)
...
etmmanager_resource_rc.o: $(srcdir)/src/res/resource.rc
	$(WINDRES) -i$< -o$@  --include-dir /usr/include/mysql --include-dir /usr/local/include/mysql++ --include-dir /usr/include/mysql++
...
.PHONY: all install uninstall clean distclean install_etmmanager \
	uninstall_etmmanager
