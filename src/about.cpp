...
const long about::ID_STATICTEXT13 = wxNewId();
const long about::ID_STATICTEXT14 = wxNewId();
const long about::ID_STATICTEXT15 = wxNewId();
...
about::about(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText1 = new wxStaticText(Panel2, ID_STATICTEXT1, _("ETM manager"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	...
	StaticText8 = new wxStaticText(Panel2, ID_STATICTEXT8, _("http://etm.leonti.ru"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT8"));
	...
	StaticText11 = new wxStaticText(Panel1, ID_STATICTEXT11, _("Russian"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT11"));
	FlexGridSizer3->Add(StaticText11, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	StaticText12 = new wxStaticText(Panel1, ID_STATICTEXT12, _("Polish"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT12"));
	FlexGridSizer3->Add(StaticText12, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	StaticText13 = new wxStaticText(Panel1, ID_STATICTEXT13, _("Spanish"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT13"));
	FlexGridSizer3->Add(StaticText13, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	StaticText14 = new wxStaticText(Panel1, ID_STATICTEXT14, _("Rui Miguel:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT14"));
	...
	StaticText15 = new wxStaticText(Panel1, ID_STATICTEXT15, _("Portuguese"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT15"));
